    ...
    return (
        <NavLink to={`/${path}/${id}`}>
            <div className="card hover:shadow-lg w-[260px] rounded-md cursor-pointer relative">
                ...
                <span className="card-arrow bg-[#595CFF] w-[35px] h-[35px]  items-center justify-center rounded-full text-[25px] absolute bottom-[88px] right-[12px]"><i class='bx bx-right-arrow-alt text-white'></i></span>
